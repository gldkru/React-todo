      ...
      <div className='space-y-4 p-6'>
        ...
        <label className='flex h-14 items-center space-x-4 rounded-md border p-4'>
          ...
          <div className='grow truncate'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos iure temporibus blanditiis et adipisci, iusto
            ipsam cum unde repellendus saepe itaque suscipit eos, corporis possimus consequuntur magnam non eligendi!
            Voluptas?
          </div>
          {/* Task remove */}
          <Button size='small' className='shrink-0 hover:bg-red-600 hover:text-white'>
